...
do 
	...
	exp=`basename $f | cut -f 1 -d '_'`
	
	regions="./regions_sep/"$exp"_0hr_K4me3.regions.bed.sorted.rm"
	intersectBed -wa -wb -sorted -a $f -b $regions | cut -f 1,2,3,4 | uniq > ./tss_clusters_all/peaksonly/$dir.filtered.bed 
